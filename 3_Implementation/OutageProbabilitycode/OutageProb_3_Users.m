...
a2 = 0.3; % power-allocation coefficient for the user2 
a3 = 0.6; % power-allocation coefficient for the user2
...
figure;
semilogy(SNR_dB, Outage_P1, '-sr', SNR_dB, Outage_P2, '-og', SNR_dB, Outage_P3, '->k');
grid on;

xlabel('SNR (dB)');
ylabel('Outage Probability');
title('Outage Probability vs SNR Plot for Three users');
legend({'User1 - NOMA','User2 -NOMA','User3 -NOMA'}, 'Location', 'Best', 'FontSize', 15);
